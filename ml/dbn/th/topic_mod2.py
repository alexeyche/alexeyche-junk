...
train_params = {'batch_size' : 100, 'learning_rate' : 0.1, 'cd_steps' : 1, 'max_epoch' : 2000, 'persistent_on' : False, 'init_momentum' : 0.5, 'momentum' : 0.9, 'moment_start' : 0.01, 'weight_decay' : 0.0002, 'introspect_freq' : 10 } 
num_hid = 15
...
log_z = ais.est_log_part_fun()
probs = log_prob_data(rbm, log_z, data)
