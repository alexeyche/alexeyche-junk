...
neurons$connectFF(connection, start_w.M)
...
patterns = list(data=net,label=1)
train_net = NetClass$new(list(patterns), list(neurons), 30000)

sim_opt = list(dt=dt, saveStat=TRUE, learn=FALSE, determ=FALSE)
