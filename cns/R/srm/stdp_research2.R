...
gr1 = TSNeurons$new(M)
l = SRMLayerClass$new(N, start_w.N, net_edge_prob, syn_delay_rate=1, axon_delay_rate=1,delay_dist_gain=5)
l$connectFF(gr1$ids(), start_w.M, syn_delay_rate=1, delay_dist_gain=5)
