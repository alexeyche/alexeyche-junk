...
\title[Спайковые нейросетевые методы]{Разработка методов применения спайковых нейронных сетей} % The short title appears at the bottom of every slide, the full title is only on the title page
