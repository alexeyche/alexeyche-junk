...
if PARAM.T>10
    ...
    for i=1:nsl
        ...
        save('-V7', ['../data/spikeList.' sprintf('%03d',PARAM.randState) '.' sprintf('%03d',i) '.mat'], 'sl');
    end
end
...
if PARAM.nAfferent==1 && plotRate
    ...
    rCoef = (r+k)/(mean(r)+k);
    save('-V7', ['../data/timeCompression.' sprintf('%03d',PARAM.randState) '.mat'], 'timeCompression');
    save('-V7', ['../data/rCoef.' sprintf('%03d',PARAM.randState) '.mat'], 'rCoef');
