...
//} FloatMessage;
//
//FloatMessage* run_server(int port) {
...
//    
//    float out[m.nrow*m.ncol];
//    float buf[1000];  
//    int k;  
//    int k_all = 0;
//    while(1) 
//    {      
//        k = recv(temp_sock_desc, buf, 4000, 0);      
//        if (k == -1)
//        {
...
//    FloatMessage *fm = (FloatMessage*)malloc(sizeof(FloatMessage));
//    fm->x = out;
//    fm->name = m.var_name;
//    fm->nrow = m.nrow;
//    fm->ncol = m.ncol;
