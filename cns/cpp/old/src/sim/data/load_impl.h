 ...
 * @author Ryan Curtin
 *
 * Implementation of templatized load() function defined in load.h.
 *
 ...
 */
#ifndef __SIM_CORE_DATA_LOAD_IMPL_H
#define __SIM_CORE_DATA_LOAD_IMPL_H
          ...
          bool transpose)
{
  ...
  else if (extension == "txt")
  {
    ...
    // This is taken from load_auto_detect() in diskio_meat.h
